    ...
    public class MarketHeroListWindow : BaseWindow
    {
        ...
        public class HeroCard
        {
            ...
            public void ReFreshCardTag()
            {
                ...
                int tag = -1;
                if (mGoodInfo.ConfigType == GSToGC.GoodsCfgInfo.CfgType.CfgTypeDiscount)
                {
                    tag = 0;
                }
                else if (mGoodInfo.ConfigType == GSToGC.GoodsCfgInfo.CfgType.CfgTypehot)
                {
                    tag = 1;
                }
                else if (mGoodInfo.ConfigType == GSToGC.GoodsCfgInfo.CfgType.CfgTypeNew)
                {
                    tag = 2;
                }
